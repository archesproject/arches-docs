...
:Python >= 3.12 (3.14 is recommended): - Installation: https://www.python.org/downloads/
    - Python 3.12 and later comes with pip
...
:PostgreSQL >= 16 (18 is recommended) with PostGIS >= 3.5:
